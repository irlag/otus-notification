...
helm-install: ## Deploy application using helm
	helm install otus-notification ./ --namespace ${NAMESPACE} --create-namespace

.PHONY: helm-upgrade
helm-upgrade: ## Upgrade application using helm
	helm upgrade otus-notification ./ --namespace ${NAMESPACE} --create-namespace

.PHONY: helm-uninstall
helm-uninstall: ## Uninstall application using helm
	helm uninstall otus-notification --namespace ${NAMESPACE}
